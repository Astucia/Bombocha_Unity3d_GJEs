...
@XmlRoot("SelectBuscaUsuarioXEMail")
public class SelectBuscaUsuarioXEMail
{
    @XmlArray("ArrayOfSelectBuscaUsuarioXEMailResult")
    @XmlArrayItem("SelectBuscaUsuarioXEMailResult")
    public var ArrayOfSelectBuscaUsuarioXEMailResult : List.<SelectBuscaUsuarioXEMailResult> = new List.<SelectBuscaUsuarioXEMailResult>();

    //Loads the xml directly from the given string. Useful in combination with www.text.
    public static function LoadFromText(text : String):SelectBuscaUsuarioXEMail
        {
            var serializer : XmlSerializer = new XmlSerializer(SelectBuscaUsuarioXEMail);
            var Resp : SelectBuscaUsuarioXEMail;

            Resp = serializer.Deserialize(new StringReader(text)) as SelectBuscaUsuarioXEMail;
